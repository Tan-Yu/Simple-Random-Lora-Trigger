...
class EasyUseDynamicLoraStack:
    ...
    Uses dynamic widget manipulation like EasyUse does.
    """
    ...
    def stack(self, toggle, mode, num_loras, seed, selection_mode, min_random, max_random, 
...
NODE_DISPLAY_NAME_MAPPINGS = {
    "EasyUse Dynamic LoRA Stack": "🎯 EasyUse Dynamic LoRA Stack",
}